...
import time
import threading
from prv.seq.tpl.daq import LoadOlasConfig
...
class Tpl(Sequence):
    ...
    def create_stop_sw(tpl=None, **kw):
        ...
        systems = Sequence.create(
            ...
            ait(partial(tpl.stop_job, nomad_client=my_nomad, job_id="fsc"),
                    name="stop FCS"),
            ait(partial(tpl.stop_job, nomad_client=my_nomad, job_id="prvccf"),
                    name="stop CCF"),
        ...
        devsim = Sequence.create(
            ...
            ait(partial(tpl.stop_job, nomad_client=my_nomad, job_id="motor1sim"),
                    name="stop secondary motor simulator"),
        ...
        broker = ait(partial(tpl.stop_job, nomad_client=my_nomad,
                 job_id="prvbroker"), name="stop DDT Broker")
    ...
    def create_start_sw(tpl=None, **kw):
        ...
        broker = ait(partial(tpl.start_job, nomad_client=my_nomad,
                job_file="prvbroker.nomad"), name="start DDT broker")
        ...
        devsim = Sequence.create(
                ...
                ait(partial(tpl.start_job, nomad_client=my_nomad, job_file="motor1sim.nomad"),
                        name="start secondary motor simulator"),
    ...
    def create_operational(tpl=None, **kw):
        ...
        init = ait(partial(tpl.init_sw, timeout=30000),
                       name="Move to NotOperational/Ready")
        enable = ait(partial(tpl.enable_sw, timeout=30000),
