...
from f1.seq.tpl.daq import (DaqException, DaqState, DaqSubState,
...
class Tpl(Sequence):
    async def init(self):
        ...
        self.olas_receiver: OlasReceiver = LoadOlasConfig("fors1")
    ...
    def create(*args, **kw):
        ...
        s = Sequence.create(a.init, a.setup, p, name="f1_img_cal_bias", **kw)
        return s
