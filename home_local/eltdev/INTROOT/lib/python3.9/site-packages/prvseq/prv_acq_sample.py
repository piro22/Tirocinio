...
import prv.fcs.clib.fcs_async_commands as fcs
...
async def start_ccfgui(uri: str):
    ...
    cmd = f"ccfGui -r \"{uri}/\" -p cii.oldb:///elt/prv/dcs &"
    await asyncio.create_subprocess_shell(cmd, stdin=asyncio.subprocess.DEVNULL,
                                          stdout=asyncio.subprocess.DEVNULL)
...
class Tpl(Sequence):
    async def init(self):
        ...
        self.ddt_uri = self.cons.get_uri("prvbroker")
