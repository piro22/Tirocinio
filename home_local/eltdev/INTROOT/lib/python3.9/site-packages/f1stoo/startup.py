...
import time
import threading
from f1.seq.tpl.daq import LoadOlasConfig
...
class Tpl(Sequence):
    ...
    def start_job(self, nomad_client, job_file):
        ...
        """
        filename = "/home_local/eltdev/fors1/f1-resource/nomad" + "/" + job_file
    ...
    def create_stop_sw(tpl=None, **kw):
        ...
        systems = Sequence.create(
            ...
            ait(partial(tpl.stop_job, nomad_client=my_nomad, job_id="fcs"),
                    name="stop FCS"),
            ait(partial(tpl.stop_job, nomad_client=my_nomad, job_id="f1ccf"),
                    name="stop CCF"),
        ...
        broker = ait(partial(tpl.stop_job, nomad_client=my_nomad,
                 job_id="f1broker"), name="stop DDT Broker")
    ...
    def create_start_sw(tpl=None, **kw):
        ...
        broker = ait(partial(tpl.start_job, nomad_client=my_nomad,
                job_file="f1broker.nomad"), name="start DDT broker")
