...
class Tpl(Sequence):
    ...
    async def take_exposure(self):
        ...
        with CcfAsyncCommands(self.ccf_uri, 60000) as ccf_if:
            ...
            try:
                ...
                logger.info(
                    f"Awaiting completion of data acquisition '{daq.daq_id}' with a timeout of {timeout}")
                ...
                if did_timeout:
                    ...
                    raise RuntimeError(
                        "Data acquisition '{daq.daq_id}' did not complete within {timeout} seconds timeout.")
    ...
    def create(*args, **kw):
        ...
        s = Sequence.create(a.init, a.setup, p, name="tdm_img_cal_bias", **kw)
        return s
