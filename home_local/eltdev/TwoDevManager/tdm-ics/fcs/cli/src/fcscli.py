...
@brief FCS Shell to interact with the Device Manager

Usage: fcscli [OPTIONS]
...
@click.command()
@click.option('--name', default='devmgr-req', help='registered name in Consul')
@click.option('--uri', default='none', help='service uri. e.g. zpb.rr://134.171.3.48:22898')
@click.option('--module', default='tdm.fcs.clib.fcs_async_commands', help='python module implementing the commands')
@click.option('--class_name', default='FcsAsyncCommands', help='Command class')
